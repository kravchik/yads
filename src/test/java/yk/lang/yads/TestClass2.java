...
public class TestClass2 {
    ...
    public TestClass2 setSs(YList<String> ss) {
        this.ss = ss;
        return this;
    }

    public TestClass2 setA(float a) {
        this.a = a;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (Float.compare(that.a, a) != 0) {
            return false;
        }
        if (Float.compare(that.b, b) != 0) {
            return false;
        }
        return ss != null ? ss.equals(that.ss) : that.ss == null;
    }
